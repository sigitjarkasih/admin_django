...
def imageUpload(request):
    ...
    if request.method == "POST":
        ...
        dataPenjual = ArticlePenjual.objects.get(id=id)
                
        # HAPUS YANG LAMA
        old_image_link = dataPenjual.image_link
        ...
        fs.save("penjual/" + new_filename, upload_file)

        # UPDATE RECORD
        dataPenjual.image_link = "/media/penjual/" + new_filename
        dataPenjual.save()
