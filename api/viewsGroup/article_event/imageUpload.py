...
def imageUpload(request):
    ...
    if request.method == "POST":
        ...
        dataEvent = ArticleEvent.objects.get(id=id)
                
        # HAPUS YANG LAMA
        old_image_link = dataEvent.image_link
        ...
        fs.save("event/" + new_filename, upload_file)

        # UPDATE RECORD
        dataEvent.image_link = "/media/event/" + new_filename
        dataEvent.save()
