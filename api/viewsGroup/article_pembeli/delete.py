...
import json
from api.database.dgmall.article_pembeli import ArticlePembeli
...
def delete(request):
    ...
    if request.method == "POST":
        ...
        dataArticle = ArticlePembeli.objects.get(id=dataRequest["id"])
        ...
        ArticlePembeli.objects.filter(id=dataRequest["id"]).delete()
