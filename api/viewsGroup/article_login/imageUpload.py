...
def imageUpload(request):
    ...
    if request.method == "POST":
        ...
        dataLogin = ArticleLogin.objects.get(id=id)
                
        # HAPUS YANG LAMA
        old_image_link = dataLogin.image_link
        ...
        fs.save("login/" + new_filename, upload_file)

        # UPDATE RECORD
        dataLogin.image_link = "/media/login/" + new_filename
        dataLogin.save()
