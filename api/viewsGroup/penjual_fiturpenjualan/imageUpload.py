...
def imageUpload(request):
    ...
    if request.method == "POST":
        ...
        dataFiturPenjualan = FiturPenjualan.objects.get(id=id)
        ...
        fs.save("fitur_penjualan/" + new_filename, upload_file)

        # UPDATE RECORD
        dataFiturPenjualan.image_link = "/media/fitur_penjualan/" + new_filename
        dataFiturPenjualan.save()
